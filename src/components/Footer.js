          ...
          <div className="row">
            <div className="col-sm-6 col-md-6 col-lg-4 col-xl-4 py-3 py-md-5 pe-xl-5 text-center">
              <div className="footer-about">
                ...
                <Link className="email-link d-block fw-medium" href="#">
                  ...
                  <span>support@FindHusly.com</span>
                </Link>
              </div>
            </div>
            <div className="col-6 col-sm-6 col-md-6 col-lg-auto col-xl-2 py-3 py-md-5">
              ...
              <ul className="footer-link list-unstyled menu mb-0">
                ...
                <li className="mb-2">
                  <Link href="home-2" className="link d-block">
                    Home Two
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="home-3" className="link d-block">
                    Home Three
                  </Link>
                </li>
                <li className="mb-2">
                ...
                <li className="mb-2">
                  <Link href="properties-grid" className="link d-block">
                    Properties Grid
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="property-details" className="link d-block">
                    Property Details 1
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="property-details-2" className="link d-block">
                    Property Details 2
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-6 col-sm-4 col-md-4 col-lg-auto col-xl-2 py-3 py-md-5">
              ...
              <ul className="footer-link list-unstyled menu mb-0">
                ...
                <li className="mb-2">
                  <Link href="agent-grid" className="link d-block">
                    Agents Grid
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="agent-details" className="link d-block">
                    Agent Details
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="blog-1" className="link d-block">
                    Blog 1
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="blog-2" className="link d-block">
                    Blog 2
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="blog-details" className="link d-block">
                    Blog Details
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-6 col-sm-4 col-md-4 col-lg-3 col-xl-2 py-3 py-md-5 d-lg-none d-xl-block">
              ...
              <ul className="footer-link list-unstyled menu mb-0">
                <li className="mb-2">
                  <Link href="style-guide" className="link d-block">
                    Style Guide
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="signin" className="link d-block">
                    Sign In
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="signup" className="link d-block">
                    Sign Up
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="forgot-password" className="link d-block">
                    Forgot Password
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="two-factor-auth" className="link d-block">
                ...
                <li className="mb-2">
                  <Link href="not_found" className="link d-block">
                    404 Page
                  </Link>
                </li>
                <li className="mb-2">
                  <Link href="505" className="link d-block">
                    505 Page
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-6 col-sm-4 col-md-4 col-lg col-xl-2 py-3 py-md-5">
              ...
              <ul className="list-unstyled social-icon">
                ...
                <li>
                  <Link href="#" className="align-items-center d-flex">
                    <div className="align-items-center bg-primary d-flex d-inline-block fs-19 icon-wrap justify-content-center me-3 rounded-2 text-center text-white dri">
          ...
          <div className="py-4">
            ...
            <div className="align-items-center row mb-2">
              ...
              <div className="col-sm-auto copy">
                © 2022 FindHusly - All Rights Reserved
              </div>
