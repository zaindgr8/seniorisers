            ...
            <div className="row g-4 mb-5">
              ...
              <div className="col-md-8">
                <p className="mb-0">
                  ...
                  possimus repellendus explicabo libero nulla? Dolorum sunt
                  quasi ut reiciendis aspernatur porro nam beatae aliquid non
                  modi cum, soluta magni asperiores fugiat, explicabo voluptatem
                  fugit, placeat nobis quis quisquam. At, atque ratione
                  inventore doloribus eos tenetur, corrupti perspiciatis aperiam
                  quasi esse, nisi dolor ducimus?
                </p>
              </div>
            </div>
            <div className="row g-4 mb-5">
              ...
              <div className="col-md-8">
                <div className="align-items-end g-4 row">
                  ...
                  <div className="col-auto">
                    <button
                      type="button"
                      className="btn btn-primary hstack gap-2"
                    >
                      <span>Button</span>
                      <span className="vr" />
